...
class Ui_Dialog(QWidget):
    def __init__(self):
        super().__init__()
    def setupUi(self, Dialog,room_num):
        self.Dialog = Dialog
        ...
        self.lineEdit = MyLineEdit(self.layoutWidget)
        ...
        self.lineEdit.setText(room_num)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "续住至"))
    ...
    def extend(self):
        ...
        try:
            ...
            if int(cur_year)>int(new_year):
                QMessageBox.warning(self, '警告', '不能早于当前的房间期限！\n当前房间期限:%s'%data[-1], QMessageBox.Ok)
                return
            ...
            if int(cur_day)>int(new_day):
                ...
                return
            if int(cur_day)==int(new_day):
                QMessageBox.warning(self, '警告', '不能和当前房间期限相同！\n当前房间期限:%s'%data[-1], QMessageBox.Ok)
                return
